<?php
    ...
    if(isset($_GET['id_user']) && isset($_GET['action']) && isset($_GET['id_recette']) && isset($_GET['owner'])){
        $action = $_GET['action'];
        ...
        if($action == 'addFav'){
            ...
            header("Location: https://l1.dptinfo-usmb.fr/~grp9/public/profil.php?owner=$owner&id_recette=$recette_id");
            exit;
    ...
    }else if(isset($_GET['id_user']) && isset($_GET['action']) && isset($_GET['id_recette']) && !isset($_GET['owner'])){
        $action = $_GET['action'];
        $user_id = $_GET['id_user'];
        $recette_id = $_GET['id_recette'];
        if($action == 'delete'){
            deleteRecette($conn, $recette_id);
            header("Location: https://l1.dptinfo-usmb.fr/~grp9/public/recettes.php");
            exit;
