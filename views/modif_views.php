<?php
    require_once(__DIR__ . '/../crud/ingrdients.crud.php');
    require_once(__DIR__ . '/../crud/recette.crud.php');
    ...
    function createHtmlModifForm($conn, $id){
        ...
        $html .= "<p>Entrez une brève description de la recette* : <textarea id='description' name='description' required='required' value=$desc></textarea></p>";
        ...
        $html .= "<p>Entrez l'indice de prix de la recette* <input type='range' id='price_ind' name='price_ind' min='1' max='5' value='1' step='1' value=$price_ind /></p>";
        $html .= "<p>Entrez l'indice de santé de la recette* <input type='range' id='health_ind' name='health_ind' min='1' max='5' value='1' step='1' value=$health_ind/></p>";
        $html .= "<p>Saison de consommation suggerée : <select name='saison' id='saison' required='required' value=$saison >";
